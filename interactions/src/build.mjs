...
// pointing hand (hyperlink hand), index finger up
const HAND = [
  [4.1,4.0],[4.2,2.1],[4.9,0.9],[6.1,0.4],[7.1,1.0],[7.4,2.2],[7.4,9.0],
  [8.3,8.3],[9.0,8.6],[9.7,8.2],[10.4,8.6],[11.0,8.4],[11.8,9.1],[12.5,10.4],
  [12.8,15.0],[12.2,20.2],[10.7,23.6],[7.6,25.1],[4.7,24.3],[3.3,21.4],
  [3.0,16.4],[2.0,14.4],[2.3,11.9],[3.7,11.2],[3.9,9.0],
];
...
// grabbing (closed fist) — 4 knuckle bumps on top, thumb left
const FIST = [
  [2.4,10.0],[2.6,7.6],[3.8,7.0],[4.6,7.6],
  [4.9,6.2],[6.0,5.6],[6.9,6.2],
  [7.2,6.0],[8.3,5.6],[9.2,6.3],
  [9.6,6.6],[10.6,6.4],[11.3,7.2],
  [12.0,9.0],[12.2,14.5],[11.4,18.6],[9.4,20.6],[6.0,21.0],
  [3.2,19.6],[2.1,16.5],[1.9,13.0],[2.2,11.5],
];
add("Grabbing (closed hand)", [ poly(FIST, { closed: true, fill: FILL }) ]);

// grab (open hand) — four fingers up + thumb
const OPEN = [
  [2.0,13.0],[2.2,10.6],[3.0,10.2],[3.4,10.8],   // thumb (left)
  [3.5,7.0],[4.0,6.4],[4.6,7.0],[4.8,10.6],       // finger 1
  [4.9,5.6],[5.4,5.0],[6.0,5.6],[6.1,10.6],       // finger 2
  [6.3,5.4],[6.8,4.8],[7.4,5.4],[7.5,10.8],       // finger 3
  [7.8,6.2],[8.3,5.7],[8.9,6.3],[9.0,11.2],       // finger 4 (pinky, shorter)
  [10.2,11.6],[11.0,13.4],[11.2,17.0],            // outer palm
  [10.6,20.4],[8.8,22.2],[5.6,22.4],
  [3.0,21.0],[1.9,18.0],[1.6,15.0],
];
